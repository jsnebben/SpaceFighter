...
<member name="T:MenuItem" decl="false" source="c:\users\ryan appel\desktop\spacefighter\spacefighter\menuitem.h" line="29">
<summary>Class for selectable menu items.</summary>
</member>
<member name="M:MenuItem.Update(GameTime!System.Runtime.CompilerServices.IsConst*)" decl="false" source="c:\users\ryan appel\desktop\spacefighter\spacefighter\menuitem.h" line="44">
<summary>Used to update the item.
<param name="pGameTime">A pointer to the game's timing values.</param>
</summary>
</member>
<member name="M:MenuItem.Draw(GameTime!System.Runtime.CompilerServices.IsConst*)" decl="true" source="c:\users\ryan appel\desktop\spacefighter\spacefighter\menuitem.h" line="49">
<summary>Used to draw the item.
<param name="pGameTime">A pointer to the game's timing values.</param>
</summary>
</member>
<member name="M:MenuItem.Select(MenuScreen*)" decl="true" source="c:\users\ryan appel\desktop\spacefighter\spacefighter\menuitem.h" line="55">
...
<member name="M:MenuItem.IsSelected" decl="false" source="c:\users\ryan appel\desktop\spacefighter\spacefighter\menuitem.h" line="65">
...
<member name="M:MenuItem.SetSelected(System.Boolean!System.Runtime.CompilerServices.IsConst)" decl="false" source="c:\users\ryan appel\desktop\spacefighter\spacefighter\menuitem.h" line="70">
...
<member name="M:MenuItem.SetFont(ALLEGRO_FONT*)" decl="false" source="c:\users\ryan appel\desktop\spacefighter\spacefighter\menuitem.h" line="76">
...
<member name="M:MenuItem.SetPosition(Vector2!System.Runtime.CompilerServices.IsConst)" decl="false" source="c:\users\ryan appel\desktop\spacefighter\spacefighter\menuitem.h" line="82">
...
<member name="M:MenuItem.SetColor(ALLEGRO_COLOR!System.Runtime.CompilerServices.IsConst)" decl="false" source="c:\users\ryan appel\desktop\spacefighter\spacefighter\menuitem.h" line="88">
<summary>Sets the color for the item text.
<param name="color">The color that the menu item text will be rendered.</param>
</summary>
</member>
<member name="M:MenuItem.SetAlpha(System.Single!System.Runtime.CompilerServices.IsConst)" decl="false" source="c:\users\ryan appel\desktop\spacefighter\spacefighter\menuitem.h" line="93">
<summary>Sets the opacity for the item text.
<param name="alpha">The opacity that the menu item text will be rendered.</param>
</summary>
</member>
<member name="M:MenuItem.SetAlignment(System.Int32!System.Runtime.CompilerServices.IsConst)" decl="false" source="c:\users\ryan appel\desktop\spacefighter\spacefighter\menuitem.h" line="98">
...
<member name="T:MenuScreen" decl="false" source="c:\users\ryan appel\desktop\spacefighter\spacefighter\menuscreen.h" line="22">
...
<member name="T:MainMenuScreen" decl="false" source="c:\users\ryan appel\desktop\spacefighter\spacefighter\mainmenuscreen.h" line="20">
<summary>Class for the game's main menu</summary>
</member>
<member name="M:MainMenuScreen.LoadContent" decl="true" source="c:\users\ryan appel\desktop\spacefighter\spacefighter\mainmenuscreen.h" line="30">
<summary>Used to load the menu's content.</summary>
</member>
<member name="M:MainMenuScreen.Update(GameTime!System.Runtime.CompilerServices.IsConst*)" decl="true" source="c:\users\ryan appel\desktop\spacefighter\spacefighter\mainmenuscreen.h" line="33">
<summary>Used to update the menu.
<param name="pGameTime">A pointer to the game's timing values.</param>
</summary>
</member>
<member name="M:MainMenuScreen.Draw(GameTime!System.Runtime.CompilerServices.IsConst*)" decl="true" source="c:\users\ryan appel\desktop\spacefighter\spacefighter\mainmenuscreen.h" line="38">
...
<member name="T:GameplayScreen" decl="false" source="c:\users\ryan appel\desktop\spacefighter\spacefighter\gameplayscreen.h" line="23">
<summary>Class for the gameplay screen. Where all of the action takes place!</summary>
</member>
<member name="M:GameplayScreen.LoadContent" decl="true" source="c:\users\ryan appel\desktop\spacefighter\spacefighter\gameplayscreen.h" line="32">
<summary>Used to load the screen's content.</summary>
</member>
<member name="M:GameplayScreen.UnloadContent" decl="true" source="c:\users\ryan appel\desktop\spacefighter\spacefighter\gameplayscreen.h" line="35">
<summary>Used to unload the screen's content.</summary>
</member>
<member name="M:GameplayScreen.HandleInput(InputState*)" decl="true" source="c:\users\ryan appel\desktop\spacefighter\spacefighter\gameplayscreen.h" line="38">
<summary>Used to manage what the screen should do based on the user input.
<param name="pInput">A pointer to the input state.</param>
</summary>
</member>
<member name="M:GameplayScreen.Update(GameTime!System.Runtime.CompilerServices.IsConst*)" decl="true" source="c:\users\ryan appel\desktop\spacefighter\spacefighter\gameplayscreen.h" line="43">
<summary>Used to update the screen.
<param name="pGameTime">A pointer to the game's timing values.</param>
</summary>
</member>
<member name="M:GameplayScreen.Draw(GameTime!System.Runtime.CompilerServices.IsConst*)" decl="true" source="c:\users\ryan appel\desktop\spacefighter\spacefighter\gameplayscreen.h" line="48">
<summary>Used to reneder the screen.
<param name="pGameTime">A pointer to the game's timing values.</param>
</summary>
</member>
