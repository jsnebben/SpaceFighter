...
<member name="T:PauseScreen" decl="false" source="c:\users\ryan appel\desktop\spacefighter\spacefighter\pausescreen.h" line="22">
<summary>Class for the pause screen.</summary>
</member>
<member name="M:PauseScreen.HandleInput(InputState*)" decl="true" source="c:\users\ryan appel\desktop\spacefighter\spacefighter\pausescreen.h" line="31">
<summary>Used to manage what the screen should do based on the user input.
<param name="pInput">A pointer to the input state.</param>
</summary>
</member>
<member name="M:PauseScreen.Draw(GameTime!System.Runtime.CompilerServices.IsConst*)" decl="true" source="c:\users\ryan appel\desktop\spacefighter\spacefighter\pausescreen.h" line="36">
<summary>Used to reneder the screen.
<param name="pGameTime">A pointer to the game's timing values.</param>
</summary>
</member>
...
<member name="T:SmallBioEnemy" decl="false" source="c:\users\ryan appel\desktop\spacefighter\spacefighter\smallbioenemy.h" line="20">
...
<member name="M:SmallBioEnemy.Update(GameTime!System.Runtime.CompilerServices.IsConst*)" decl="true" source="c:\users\ryan appel\desktop\spacefighter\spacefighter\smallbioenemy.h" line="35">
<summary>Used to update the enemy.
<param name="pGameTime">A pointer to the game's timing values.</param>
</summary>
</member>
<member name="M:SmallBioEnemy.Draw(GameTime!System.Runtime.CompilerServices.IsConst*)" decl="true" source="c:\users\ryan appel\desktop\spacefighter\spacefighter\smallbioenemy.h" line="40">
<summary>Used to reneder the enemy.
<param name="pGameTime">A pointer to the game's timing values.</param>
</summary>
</member>
<member name="M:SmallBioEnemy.ToString" decl="false" source="c:\users\ryan appel\desktop\spacefighter\spacefighter\smallbioenemy.h" line="45">
<summary>Gets a string representation of the game object.
<returns>The game object's string representation.</returns>
</summary>
</member>
<member name="M:SmallBioEnemy.GetHalfDimensions" decl="false" source="c:\users\ryan appel\desktop\spacefighter\spacefighter\smallbioenemy.h" line="50">
<summary>Gets the half-width and half-height of the game object.
<returns>The half dimensions of the game object.</returns>
</summary>
</member>
<member name="T:Level_1" decl="false" source="c:\users\ryan appel\desktop\spacefighter\spacefighter\level_1.h" line="22">
<summary>Class for Level 1</summary>
</member>
<member name="M:Level_1.InitializeEnemies" decl="true" source="c:\users\ryan appel\desktop\spacefighter\spacefighter\level_1.h" line="32">
<summary>Used to setup the enemies at the beginning of the level.</summary>
</member>
<member name="M:Level_1.Update(GameTime!System.Runtime.CompilerServices.IsConst*)" decl="true" source="c:\users\ryan appel\desktop\spacefighter\spacefighter\level_1.h" line="35">
<summary>Used to update the level.
<param name="pGameTime">A pointer to the game's timing values.</param>
</summary>
</member>
